...
import '/componentes/editarcadastro/editarcadastro_widget.dart';
import '/componentes/lista_vazia/lista_vazia_widget.dart';
import '/componentes/view_cadastro/view_cadastro_widget.dart';
...
import 'tela_admin_model.dart';
export 'tela_admin_model.dart';

class TelaAdminWidget extends StatefulWidget {
  const TelaAdminWidget({super.key});

  @override
  State<TelaAdminWidget> createState() => _TelaAdminWidgetState();
}

class _TelaAdminWidgetState extends State<TelaAdminWidget>
    with TickerProviderStateMixin {
  late TelaAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TelaAdminModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.listUsers = await queryUsuarioRecordOnce(
        queryBuilder: (usuarioRecord) => usuarioRecord.where(
          'admin',
          isEqualTo: false,
        ),
      );
      _model.listUsuarios = _model.listUsers!.toList().cast<UsuarioRecord>();
      setState(() {});
      _model.search = true;
      setState(() {});
    });
    ...
    _model.textFieldInstituicaoTextController ??= TextEditingController();
    ...
    _model.textFiedCepTextController ??= TextEditingController();
    _model.textFiedCepFocusNode ??= FocusNode();

    _model.textFieldEnderecoTextController ??= TextEditingController();
    _model.textFieldEnderecoFocusNode ??= FocusNode();

    _model.textFieldResponsavelTextController ??= TextEditingController();
    ...
    _model.textFieldEmailRespTextController ??= TextEditingController();
    _model.textFieldEmailRespFocusNode ??= FocusNode();

    _model.textFieldTelRespTextController ??= TextEditingController();
    _model.textFieldTelRespFocusNode ??= FocusNode();

    _model.textFieldNomeResp2TextController ??= TextEditingController();
    _model.textFieldNomeResp2FocusNode ??= FocusNode();

    _model.textFieldCargoResp2TextController ??= TextEditingController();
    _model.textFieldCargoResp2FocusNode ??= FocusNode();

    _model.textFieldEmailResp2TextController ??= TextEditingController();
    _model.textFieldEmailResp2FocusNode ??= FocusNode();

    _model.textFieldTelResp2TextController ??= TextEditingController();
    ...
    _model.textFieldConfSenhaTextController ??= TextEditingController();
                                  ...
                                  child: Container(
                                    ...
                                    child: Stack(
                                      children: [
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return Dialog(
                                                                            ...
                                                                            backgroundColor:
                                                                                Colors.transparent,
                                                                            alignment:
                                                                                const AlignmentDirectional(0.4, -0.5).resolve(Directionality.of(context)),
                                                                            child:
                                                                                SizedBox(
                                                                              width: MediaQuery.sizeOf(context).width * 0.7,
                                                                              child: ViewCadastroWidget(
                                                                                indice: listaUsuariosItem,
                                                                              ),
                                                                            ),
                                                                          );
                                                                        },
                                                                  ...
                                                                  onPressed:
                                                                        ...
                                                                        await showDialog<bool>(
                                                                              ...
                                                                              builder: (alertDialogContext) {
                                                                                return AlertDialog(
                                                                                  ...
                                                                                  content: Text('Tem certeza que deseja deletar a ${listaUsuariosItem.displayName} ?'),
                                                                                  actions: [
                                                                                    TextButton(
                                                                    ...
                                                                    await showDialog(
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          content:
                                                                              const Text('Usuário deletado com sucesso!'),
                                                                          actions: [
                                                                            TextButton(
                                        ...
                                        if (!(_model.listUsers != null &&
                                            (_model.listUsers)!.isNotEmpty))
                                          Align(
                                            alignment:
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: SizedBox(
                                                        ...
                                                        child: TextFormField(
                                                          controller: _model
                                                              .textFiedCepTextController,
                                                          focusNode: _model
                                                              .textFiedCepFocusNode,
                                                          autofocus: true,
                                                          obscureText: false,
                                                          decoration:
                                                              InputDecoration(
                                                          ...
                                                          keyboardType:
                                                              TextInputType
                                                                  .number,
                                                          validator: _model
                                                              .textFiedCepTextControllerValidator
                                                              .asValidator(
                                                                  context),
                                                          inputFormatters: [
                                                            _model
                                            ...
                                            if (_model
                                              ...
                                              await actions.createUsers(
                                                ...
                                                _model
                                                    .textFieldCargoResp2TextController
                                                    .text,
                                                _model.textFiedCepTextController
                                                    .text,
                                              );
                                              await showDialog(
                                                context: context,
