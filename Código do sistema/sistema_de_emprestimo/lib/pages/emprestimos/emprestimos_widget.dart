...
import 'emprestimos_model.dart';
export 'emprestimos_model.dart';

class EmprestimosWidget extends StatefulWidget {
  const EmprestimosWidget({super.key});

  @override
  State<EmprestimosWidget> createState() => _EmprestimosWidgetState();
}

class _EmprestimosWidgetState extends State<EmprestimosWidget>
    with TickerProviderStateMixin {
  late EmprestimosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EmprestimosModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await Future.wait([
        ...
        Future(() async {
          _model.emprestimos = await queryEmprestimoRecordOnce(
            queryBuilder: (emprestimoRecord) => emprestimoRecord
                .where(
                  'status',
                  isEqualTo: 'Emprestado',
                )
                .where(
                  'uid_destinatario',
          ...
          _model.empAtivos =
              _model.emprestimos!.toList().cast<EmprestimoRecord>();
          setState(() {});
          FFAppState().menuSelecIndex = 'emprestimos';
          setState(() {});
        }),
      ]);
    });
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsuarioRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuarioRecord> emprestimosUsuarioRecordList = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
          body: SafeArea(
                                                        ...
                                                        child: Builder(
                                                          builder: (context) {
                                                            ...
                                                            return FlutterFlowDataTable<
                                                              ...
                                                              dataRowBuilder:
                                                                  (listaEmprestimosItem,
                                                                          listaEmprestimosIndex,
                                                                          selected,
                                                                          onSelectChanged) =>
                                                                      DataRow(
                                                                color:
                                                                ...
                                                                cells: [
                                                                  ...
                                                                  Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        emprestimosUsuarioRecordList
                                                                            .where((e) =>
                                                                                e.reference.id ==
                                                                                listaEmprestimosItem.uidRemetente)
                                                                            .toList()
                                                                            .first
                                                                            .instituicao,
                                                                        style: FlutterFlowTheme.of(context)
                                                                                  ...
                                                                                  return Dialog(
                                                                                    ...
                                                                                    child: SizedBox(
                                                                                      ...
                                                                                      child: ViewSolicitacoesWidget(
                                                                                        indice: listaEmprestimosItem,
                                                                                        remetente: emprestimosUsuarioRecordList.where((e) => e.reference.id == listaEmprestimosItem.uidRemetente).toList().first,
                                                                                      ),
                                                                                    ),
                                                                                  );
                                                                                },
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              await listaEmprestimosItem.reference.update({
                                                                                ...createEmprestimoRecordData(
                                                                                  status: 'Devolvido',
                                                                                ),
                                                                                ...mapToFirestore(
                                                                                  {
                                                                                    'dataDevolucao': FieldValue.serverTimestamp(),
                                                                                  },
                                                                                ),
                                                                              });
                                                                              _model.removeAtIndexFromEmpAtivos(listaEmprestimosIndex);
                                                                              setState(() {});
                                                                              await showDialog(
                                                                                context: context,
                                                                                builder: (alertDialogContext) {
                                                                                  return AlertDialog(
                                                                                    content: const Text('Livro devolvido com sucesso!'),
                                                                                    actions: [
                                                                                      TextButton(
