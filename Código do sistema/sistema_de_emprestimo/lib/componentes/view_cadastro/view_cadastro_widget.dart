...
import 'view_cadastro_model.dart';
export 'view_cadastro_model.dart';

class ViewCadastroWidget extends StatefulWidget {
  const ViewCadastroWidget({
    super.key,
  ...
  @override
  State<ViewCadastroWidget> createState() => _ViewCadastroWidgetState();
}

class _ViewCadastroWidgetState extends State<ViewCadastroWidget> {
  late ViewCadastroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewCadastroModel());
    ...
    _model.textFieldEnderecoTextController1 ??=
        TextEditingController(text: widget.indice?.cep);
    _model.textFieldEnderecoFocusNode1 ??= FocusNode();

    _model.textFieldEnderecoTextController2 ??=
        TextEditingController(text: widget.indice?.endereco);
    _model.textFieldEnderecoFocusNode2 ??= FocusNode();
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                                              ...
                                              child: Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .textFieldEnderecoTextController1,
                                                      focusNode: _model
                                                          .textFieldEnderecoFocusNode1,
                                                      autofocus: true,
                                                      readOnly: true,
                                                      obscureText: false,
                                                      decoration:
                                              ...
                                              child: Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .textFieldEnderecoTextController2,
                                                      focusNode: _model
                                                          .textFieldEnderecoFocusNode2,
                                                      autofocus: true,
                                                      readOnly: true,
                                                      obscureText: false,
                                                      decoration:
                        ...
                        if (widget.indice?.responsavel2 != null &&
                            widget.indice?.responsavel2 != '')
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 6.0, 0.0, 0.0),
                            child: Row(
